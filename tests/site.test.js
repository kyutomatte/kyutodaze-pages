...
test("editable CSV data drives home works and open works", async () => {
  ...
  assert.match(openWorkLinks, /sleepless,MAC OS용 다운로드,\/assets\/downloads\/sleepless\/Sleepless_0\.1\.5_aarch64\.dmg,2/);
...
test("local assets needed for the first viewport are present", () => {
  const requiredAssets = [
    ...
    "public/assets/downloads/sleepless/Sleepless_0.1.5_aarch64.dmg",
